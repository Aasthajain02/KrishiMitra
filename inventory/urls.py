...
from .views import index, add_inventory, display_inventory,generate_pdf, gemini,signup,ulogin, dashboard, make_pickaxe, make_pickaxe_page,weather_forecast
...
urlpatterns = [
    ...
    path('sign-up/',signup, name='signup'),  # Add this line
